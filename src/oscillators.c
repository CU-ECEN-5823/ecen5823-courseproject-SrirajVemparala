...
void cmu_init()
{
  ...
  CMU_ClockSelectSet(cmuClock_LFA,cmuSelect_LFXO);//select LFXO as clock. parameters: CMU_Clock_TypeDef , CMU_Select_TypeDef
  ...
  CMU_ClockSelectSet(cmuClock_LFA,cmuSelect_ULFRCO);//select ULFRCO as clock. CMU_Clock_TypeDef , CMU_Select_TypeDef
