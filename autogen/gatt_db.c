...
GATT_DATA(const uint8_t gattdb_uuidtable_128_map[]) =
{
  ...
  0x93, 0x34, 0xb3, 0xd9, 0x00, 0x91, 0xdc, 0x94, 0x84, 0x48, 0xc2, 0x33, 0x3d, 0x9a, 0x9f, 0xbb, 
  0xdb, 0xc2, 0x2c, 0xc4, 0x55, 0x7a, 0x48, 0xaf, 0x46, 0x4e, 0x83, 0xe3, 0xb2, 0x1d, 0xdb, 0xfc, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_35) = {
  .len = 16,
  .data = { 0xd4, 0x7f, 0x7d, 0x93, 0xd2, 0x71, 0x60, 0x82, 0x84, 0x44, 0x72, 0xe9, 0x9a, 0xdb, 0xf2, 0xea, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 9,
  .data = { 0x56, 0x65, 0x6d, 0x70, 0x61, 0x72, 0x61, 0x6c, 0x61, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1e, .uuid = 0x000c, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_29 },
  ...
  { .handle = 0x26, .uuid = 0x8001, .permissions = 0x4800, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_37 },
